...
export const gameinfo = {
  ...
  2: {
    ...
    "location": "Zoom",
    "gameID": 2,
    "tags": ["Magic", "intermediate", "fantasy"],
  ...
  8: {
    ...
    "location": "Zoom",
    "gameID": 8,
    "tags": ["Dungeons & Dragons", "Cyberpunk", "medium"],
...
export const hostData = {
  ...
  2077: {
    ...
    "reviews": [3, 7],
    "about": "I'm Johnny and I've hosted Cyberpunk 2077 themed games for 15 years so far. If you join one of my games you're sure to have a good time.",
    "numberOfGames": 10,
    "gamesHosted": ["Dungeons & Dragons"],
